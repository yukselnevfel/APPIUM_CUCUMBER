...
public class Driver {
    ...
    public static AndroidDriver getAndroidDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("appPackage","com.ailebutcem");// App info dan al!
            caps.setCapability("appActivity","com.ailebutcem.MainActivity");//Activite den main activitiy ya da home page activity kısımlarında bulunabilir!
